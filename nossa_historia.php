    ...
    <div class="welcome_txt container">
      <div class="welcome_txt-top">
        <h1 class="section-title">Nossa História</h1>
          ...
          <h3 style="text-align: center;">RESENHA HISTÓRIA DA INSEJEC <br>(Igreja Nacional do Senhor Jesus Cristo)</h3>
          <p>
          ...
          <br><br>
          Levar o perdido a uma experiência de verdadeira regeneração;
          Conduzir o regenerado a uma vida de santificação, buscando a semelhança de Jesus e Treinar o discípulo para a obra do ministério.
          <br><br>
          ...
          <h3 style="text-align: center;">Um Chamado e um Comando</h3>
          <p>
          ...
          <h3 style="text-align: center;">Os Primeiros passos do Ministério no Brasil</h3>
          <p>
          ...
          <h3 style="text-align: center;">Começando uma Igreja Local</h3>
          <p>
          ...
          <h3 style="text-align: center;">Três Períodos</h3>
          <p>
          <b>Primeiro Período:</b><br>
