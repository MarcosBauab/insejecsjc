...
<section id="welcome_txt">
  <div class="welcome_txt container">
    <div class="welcome_txt-top">
      <h1 class="section-title">Visão Celular</h1>

      <h3 style="text-align: center;">Origens</h3>
      <p>
      ...
      <ul style="color: #fff; font-size: 15px; font-weight:300; padding-left: 20px; text-align: justify; letter-spacing: .5px;"><br>
        <li>Todos os membros da célula são vistos como líderes em potencial, embora na prática nem todos o sejam.</li><br>
        <li>Os líderes de célula formam células de liderança, chamadas G12. Cada G12, formado exclusivamente por líderes, tem o número máximo de 12 pessoas.</li><br>
        <li>As células de liderança são fechadas e permanentes. Nelas seus membros são edificados, discipulados e supervisionados.</li><br>
        <li>As células são homogêneas. Células de homens, mulheres, jovens, profissionais, etc.</li><br>
        <li>A partir do pastor titular há uma cadeia de gerações de 12. O pastor tem 12 líderes. Cada um destes busca formar 12, que têm a meta de formar 12, e assim sucessivamente. Trata-se de uma meta de crescimento exponencial: 12, 144,1728….</li>
      </ul>
      <p>
      <br><br>
      <b>Os princípios cruciais G12 incluem:</b>
      </p>
      <ul style="color: #fff; font-size: 15px; font-weight:300; padding-left: 20px; text-align: justify; letter-spacing: .5px;"><br>
        <li><b>Cada pessoa pode</b> se tornar um líder;</li><br>
        <li><b>Cada líder pode discipular</b> e supervisionar outros líderes;</li><br>
        <li><b>As pessoas precisam ser libertas</b> (cadeias quebradas) para servirem como trabalhadores da colheita;</li><br>
        <li><b>Um claro treinamento</b> deve seguir o encontro;</li><br>
        <li><b>Deve haver oração fervorosa</b> e um claro compromisso com Cristo.</li>
      </ul>
      <p>
      <br>
      Como forma estratégica para alcançar os objetivos do G12, é seguido um programa de quatro fases, chamado “Escada do Sucesso”.
      <br><br>
      ...
      <h3 style="text-align: center;">Escada do Sucesso</h3>
      <p>
      A Escada do Sucesso é um processo de quatro etapas ensinado pelo Fundador do Movimento Internacional G12, e diligentemente aplicada em todas as Igrejas G12. Possui quatro fases: Ganhar, Consolidar, Treinar e Enviar.

      <br><br>
      </p>
      <h5 style="font-size:20px; font-variant: small-caps; text-align:center; color:#fff;">1. Ganhar</h5>
      <p>
      <br>
      ...
      <br><br>
      <b>As células são a coluna vertebral da Igreja.</b> Nossa visão não é uma Igreja com células, mas uma Igreja em Células. Nosso lema: Cada discípulo um líder e em casa uma célula.
      <br><br>
      ...
      <b>ESTRATÉGIA DE ORAÇÃO POR 3 POR 30 DIAS</b>
      <br><br>
      ...
      <b>SEMANA 1</b>
      <br></p>
      <ul style="color: #fff; font-size: 15px; font-weight:300; padding-left: 20px; text-align: justify; letter-spacing: .5px;">
        <li>1. Cada um dos dois escolhe três pessoas descrentes por quem orar por 30 dias (6 no total). Deve ser alguém que poderá participar da célula, que mora perto da casa.</li><br>
        <li>2. Cada um dos dois ora diariamente pelas seis pessoas.</li><br>
        <li>3. Encontram-se uma vez por semana para orar pelos seis nomes.</li>
      </ul><p>
      <br>
      <b>SEMANA 2</b>
      <br>
      ...
      <ul style="color: #fff; font-size: 15px; font-weight:300; padding-left: 20px; text-align: justify; letter-spacing: .5px;"><br>
        <li> Desafiar a cada membro da nova célula a ganhar um nos próximos 3 meses.</li><br>
        <li> Prepará-los para o encontro.</li>
      </ul><p>
      <br>
      ...
      <br><br>
      <b>Meta:</b> Ganhar uma vida por mês. Seguindo-se o processo, o líder formará quatro outros líderes em um ano.

      <br><br>
      </p>
      <h5 style="font-size:20px; font-variant: small-caps; text-align:center; color:#fff;">2. Consolidar</h5>
      <p>
      <br>
      ...
      <br><br>
      Objetivos: Levar o novo crente a uma profunda experiência de...</p>
      <ul style="color: #fff; font-size: 15px; font-weight:300; padding-left: 20px; text-align: justify; letter-spacing: .5px;"><br>
        <li><b>Verdadeiro arrependimento</b> e perdão de pecados;</li><br>
        <li><b>Ter plena segurança</b> de sua salvação.</li><br>
        <li><b>Romper ataduras</b> que o ligavam ao seu passado.</li><br>
        <li><b>Receber cura</b> em seu coração.</li><br>
        <li><b>Receber e experimentar</b> a plenitude do Espírito Santo em sua vida.</li><br>
        <li><b>Ter bem clara a visão</b> da missão de ganhar vidas, consolidá-las, treiná-las e enviá-las, como reprodutores de discípulos de Jesus (2 Timóteo 2:2).</li>
      </ul><p><br>


      <b>PÓS – ENCONTRO</b><br>
      Após o Encontro, seguir-se-ão sete semanas de estudos Bíblicos, uma vez por semana. <br>
      <b>Propósito:</b> Ensinar ao novo discípulo como lidar com os contra-ataques de Satanás, e como cortar sua relação com o mundo, o pecado, a carne e o diabo. Como enfrentar os problemas e vencer, escapando da tentação, e vivendo em vitória e santidade. O Pós-Encontro ensina também os novos crentes a como se relacionar com Deus. É fundamental para a consolidação e preparo para o próximo passo na Escada do sucesso.

      <br><br>
      </p>
      <h5 style="font-size:20px; font-variant: small-caps; text-align:center; color:#fff;">3. Treinar</h5>
      <p><b>Compreendendo que:</b><br></p>
      <ul style="color: #fff; font-size: 15px; font-weight:300; padding-left: 20px; text-align: justify; letter-spacing: .5px;"><br>
        <li>A Grande Comissão é fazer discípulos e ensinar-lhes todo o conselho de Deus;</li><br>
        <li>Todo crente tem um ministério a ser realizado;</li><br>
        <li>Todo crente tem dons ministeriais a serem desenvolvidos;</li><br>
        <li>Todo ministério necessita de treinamento adequado para ser realizado.</li>
      </ul>
      ...
      <br><br>
      <b>Capacitação Destino</b> é um programa interativo de discipulado para toda a igreja, fazendo de cada discípulo, um líder. Consiste em seis módulos de dez semanas cada um. Tem um ano de duração e é dividido em três etapas, com dois módulos em cada uma:
      <br></p>
      <ul style="color: #fff; font-size: 15px; font-weight:300; padding-left: 20px; text-align: justify; letter-spacing: .5px;"><br>
      <li><b>PASTOREADOS EM SEU AMOR:</b> Estabelece os fundamentos para uma vida cristã bem-sucedida.</li><br>
      <li><b>O PODER DE UMA VISÃO:</b> Tudo o que é preciso saber acerca da Visão e o necessário para colocá-la em prática.</li><br>
      <li><b>A ESTRATÉGIA DO GANHAR:</b> Aprenda como ganhar almas com eficácia em uma célula.</li><br>
      <li><b>FAMÍLIAS COM PROPÓSITO:</b> Descubra a ideia de Deus para a família e como formar famílias conforme a vontade de Deus.</li><br>
      <li><b>LIDERANÇA EFICAZ:</b> Este módulo apresenta as áreas chave que você precisará desenvolver em sua vida para se transformar em um líder de influência</li><br>
      <li><b> ESPÍRITO SANTO EM MIM:</b> Descubra como experimentar o poder do Espírito Santo em sua vida</li>
      </ul>
      <p><br>
      ...
      <ul style="color: #fff; font-size: 15px; font-weight:300; padding-left: 20px; text-align: justify; letter-spacing: .5px;"><br>
      <li><b>CONECTAR</b> os estudantes com um Deus para o qual nada é impossível.</li><br>
      <li>Ajudar os estudantes a compreenderem que cada um tem o poder de <b>CONCEBER</b> o sonho de Deus para sua vida.</li><br>
      <li>Treinar todos os membros para que sejam aqueles que podem <b>CRIAR</b> um destino de acordo com a vontade de Deus para suas vidas e Igrejas.
      </li><br>
      </ul>
      <p><br>
      ...
      <h5 style="font-size:20px; font-variant: small-caps; text-align:center; color:#fff;">4. Enviar</h5>
      <p>
      <br>
